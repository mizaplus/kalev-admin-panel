...
const sectionData = [
  {
    title: "Hero Section",
    description: "Programs page hero image, title, and tagline.",
    icon: <FaRegSmile {...iconProps} />,
  },
  {
    title: "Intro",
    description: "Section to introduce the programs offered.",
    icon: <FaInfoCircle {...iconProps} />,
  },
  {
    title: "Programs",
    description: "Our programs and services offered.",
...
const ProgramsSections = () => {
  const { loading, data } = useProgramsContext();
